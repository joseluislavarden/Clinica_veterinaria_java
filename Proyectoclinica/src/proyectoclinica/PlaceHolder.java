...
public class PlaceHolder extends JLabel implements FocusListener, DocumentListener {
	...
	public PlaceHolder(String text, JTextComponent component, Color Foreground) {
		this(text, component, Show.ALWAYS, Foreground);
	}

	public PlaceHolder(String text, JTextComponent component, Show show, Color Foreground) {
...
//		setFont(component.getFont());
		setFont(new Font("Century Gothic", Font.ITALIC, 11));
